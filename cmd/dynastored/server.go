// dynastored runs a sample implementation of a dynastore server.
//
// Most of the work is done at github.com/mateusbraga/dynastore/pkg/server.
package main
...
import (
	...
	"github.com/mateusbraga/dynastore/pkg/server"
...
func main() {
	...
	server.Run(*bindAddr, initialView)
}
